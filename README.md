<div align="center"><img src='https://github.com/wavallejol/Streamlit_Entropy/blob/main/fig3.png' width = "350" height = "350" /> </a></div> 
...
<div <p><H3><b>Entropía y Probabilidad</b></div> 
  <div align="justify">Se presenta un simulador interactivo desarrollado en streamlit, de la Curva de Distribución de Boltzmann-Maxwell como función de la temperatura para cuatro gases. Con este simulador podrás obtener la curva de distribución para el lanzamiento de dos dados y la distribución de un número determinado de particulas de un gas encerradas en una caja.</div>
